    ...
    <div class="flex-1 pl-[242px] px-8 py-8 pt-[90px] overflow-auto pb-[50px]">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="flex border-b mb-4">
                ...
                <a href="<?= site_url('admin/dashboard_kuis') ?>" class="px-4 py-2 border-t border-l border-r rounded-t-lg bg-[#176B87] hover:bg-[#176B87] hover:text-white transition text-white text-sm">
                    Kuis
                </a>
            </div>
                ...
                <table class="w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="border px-4 py-2 text-sm">Judul Kuis</th>
                            <th class="border px-4 py-2 text-sm">Jumlah Soal</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200 last:border-b-0 hover:bg-gray-50">
                            ...
                            <td class="border px-4 py-2 text-sm"><?= esc($quiz['judul']) ?></td>
                            <td class="border px-4 py-2 text-sm"><?= esc($quiz['jumlah_soal']) ?></td>
                            <td class="border px-4 py-2 text-sm">
                                <span class="<?= $quiz['status'] === 'published' ? 'text-[#176B87]' : 'text-[#44F12D]' ?>">
                                    <?= ucfirst($quiz['status']) ?>
                                </span>
                            </td>
                            <td class="border px-4 py-2 flex space-x-3 text-sm">
                                <a href="<?= site_url('admin/editKuis/' . $quiz['kuis_id'] . '?from=dashboard_kuis') ?>" class="bg-[#176B87] text-white btn-small rounded text-center inline-flex items-center">
